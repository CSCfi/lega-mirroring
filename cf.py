...
def checkFileTransmission(path):
    ...
    # This block is now implemented in main (for cmd use)
    '''while (passes < 3):
        print("jee")
        time.sleep(10)
...
def verifyFileIntegrity(path, key):
    ...
    if path_md5 == key_md5:
        print('FILE OK: Verified successfully')
    else:
        print('FILE ERROR: Transmitted file and md5checksum do not match')
